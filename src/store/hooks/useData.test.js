...
describe("Given an useData function", () => {
  ...
  describe("When the function addToApiFav is called with the showID '6'", () => {
    test("Then it should return an array with the show with showID 6'", async () => {
      const expectedShow = [
        {
          id: 6,
      ...
      const listOfChars = await waitFor(() => result.current.addToApiFav(6));
